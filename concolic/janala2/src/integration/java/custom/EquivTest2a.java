...
public class EquivTest2a {
        ...
        Table t2 = (new SelectCommand(
                new Select() {
                    public String[] selectAs() { 
                        return new String[]{"fid", "year"}; 
                    }
                    public Operations[] select() {
                        return new Operations[]{ 
                            new IdentityOperation(0, "fid"),
                            new IdentityOperation(0, "year")
                        }; 
                    }
                },
    ...
    public static void initTable2(Table table, int n) {
        ...
        int y = Main.readInt(rand.nextInt(1000));
        Main.MakeSymbolic(y);

        int z = Main.readInt(rand.nextInt(1000) + 2015);
        Main.MakeSymbolic(z);
    ...
    public static void main(String[] args){
        ...
        initTable2(smallFlights, Integer.parseInt(args[0]));
